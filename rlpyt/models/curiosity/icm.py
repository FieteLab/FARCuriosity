...
class ICM(nn.Module):
    ...
    def compute_bonus(self, observations, next_observations, actions, verbose=False):
        ...
        if verbose:
            return self.decay * self.beta * reward, reward.detach(), None
        return self.decay * self.beta * reward


    def compute_loss(self, observations, next_observations, actions, valid, indices=None):

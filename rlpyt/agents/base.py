...
MacAgentCuriosityInputs = namedarraytuple("IcmAgentCuriosityInputs", ["observation", "next_observation", "action", "valid", "done", "recall_state"])
...
class BaseAgent:
    ...
    def __init__(self, ModelCls=None, model_kwargs=None, initial_model_state_dict=None, no_extrinsic=False, dual_policy='default'):
        """
        ...
        self._recv_count = 0
        self.no_extrinsic = no_extrinsic

...
COPY ./rlpyt/envs/gym_minigrid /curiosity_baselines/rlpyt/envs/gym_minigrid
WORKDIR /curiosity_baselines/rlpyt/envs/gym_minigrid
RUN pip3 install -e .

WORKDIR /curiosity_baselines
